...
//  Device(s)...: ATMega...
//  Compiler....: AVR-GCC
//  Description.: Демонстрационный пример использования графического варианата
//				  библиотеки для экранов Nokia 1100
//  Data........: 28.03.12
//  Version.....: 2.0 
//***************************************************************************
...
int main(void)
{
	nlcd_Init();							// Инициализация библиотеки
	_delay_ms(100);							// Даем время на завершение всех процедур

  while(1)									// работаем в бесконечном цикле
  {
	nlcd_GotoXY(0,0);
